...
import com.vitatrix.backend.dto.AuthResponse;
import com.vitatrix.backend.model.UserAccount;
import com.vitatrix.backend.repository.UserAccountRepository;
import com.vitatrix.backend.security.CustomUserDetailsService;
import com.vitatrix.backend.security.JwtUtil;
...
public class AuthController {
        ...
        public ResponseEntity<AuthResponse> login(@Valid @RequestBody AuthRequest request) {
                ...
                String token = jwtUtil.generateToken(userDetails, user.getRole(), user.getFacilityName());
